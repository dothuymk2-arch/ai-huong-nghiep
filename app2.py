...
# CHÈN ĐOẠN NÀY VÀO CHỖ TRỐNG TRÊN GIAO DIỆN (SÁT LỀ TRÁI, KHÔNG THỤT LỀ)
cau_chao_ai = f"Xin chào bạn {ten_hs if ten_hs else 'học sinh'}, học sinh lớp {lop_hs if lop_hs else '9'}. Chào mừng bạn đến với hệ thống AI hướng nghiệp 8 môn toàn diện."
st.audio(f"https://translate.google.com/translate_tts?ie=UTF-8&tl=vi&client=tw-ob&q={cau_chao_ai}", format="audio/mp3")
